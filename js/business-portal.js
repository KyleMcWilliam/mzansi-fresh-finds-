...
let addNewListingBtn, listingModal, listingForm, closeModalElements, listingsContainer, noListingsMessage;
...
export function handleFormSubmit(event) {
    ...
    const formData = new FormData(listingForm); // listingForm should be in scope
    const newListing = {};
